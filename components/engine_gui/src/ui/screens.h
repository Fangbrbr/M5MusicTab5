...
enum ScreensEnum {
    ...
    SCREEN_ID_APP_RECORDER = 9,
    SCREEN_ID_APP_TINY_PIANO = 10,
    SCREEN_ID_APP_SEQUENCER = 11,
...
typedef struct _objects_t {
    ...
    lv_obj_t *app_recorder;
    lv_obj_t *app_tiny_piano;
    lv_obj_t *app_sequencer;
    ...
    lv_obj_t *obj35;
    lv_obj_t *obj36;
    lv_obj_t *launcher_head;
    lv_obj_t *obj37;
    lv_obj_t *launcher_zen;
    lv_obj_t *obj38;
    lv_obj_t *launcher_ear;
    lv_obj_t *obj39;
    lv_obj_t *launcher_recorder;
    lv_obj_t *obj40;
    ...
    lv_obj_t *obj95;
    lv_obj_t *obj96;
    lv_obj_t *zen_dropdown_sound;
    lv_obj_t *obj97;
    lv_obj_t *zen_btn_set;
    lv_obj_t *obj98;
    lv_obj_t *obj99;
    lv_obj_t *obj100;
    lv_obj_t *obj101;
    ...
    lv_obj_t *chord_btn_circle;
    lv_obj_t *chord_panel_fifth;
    lv_obj_t *fifth_btn_return;
    lv_obj_t *obj117;
    lv_obj_t *fifth_canvas_circle_1;
    lv_obj_t *fifth_panel_info_1;
    lv_obj_t *fifth_name_1;
    lv_obj_t *fifth_key_sig_1;
    lv_obj_t *obj118;
    lv_obj_t *fifth_scale_1;
    lv_obj_t *fifth_canvas_piano_1;
    lv_obj_t *obj119;
    lv_obj_t *fifth_dominant_1;
    lv_obj_t *obj120;
    lv_obj_t *fifth_parallel_1;
    lv_obj_t *obj121;
    lv_obj_t *fifth_subdominant_1;
    lv_obj_t *obj122;
    lv_obj_t *obj123;
    lv_obj_t *obj124;
    lv_obj_t *obj125;
    lv_obj_t *rec_head;
    lv_obj_t *rec_btn_home;
    lv_obj_t *obj126;
    lv_obj_t *rec_panel_list;
    lv_obj_t *rec_list_file;
    lv_obj_t *rec_del_msgbox;
    lv_obj_t *rec_led_ai;
    lv_obj_t *obj127;
    lv_obj_t *obj128;
    lv_obj_t *rec_mode_type;
    lv_obj_t *obj129;
    lv_obj_t *obj130;
    lv_obj_t *rec_storage_usage_bar;
    lv_obj_t *rec_storage_usage_text;
    lv_obj_t *obj131;
    lv_obj_t *obj132;
    lv_obj_t *rec_status;
    lv_obj_t *rec_time;
    ...
    lv_obj_t *rec_wave_8;
    lv_obj_t *rec_wave_9;
    lv_obj_t *rec_wave_10;
    lv_obj_t *rec_wave_11;
    lv_obj_t *rec_wave_12;
    lv_obj_t *rec_start_stop;
    lv_obj_t *obj134;
    lv_obj_t *obj135;
    lv_obj_t *piano_head;
    ...
    lv_obj_t *obj151;
    lv_obj_t *seq_head;
    lv_obj_t *seq_btn_home;
    lv_obj_t *seq_btn_rec;
    lv_obj_t *obj152;
    lv_obj_t *seq_label_bpm_slide;
    lv_obj_t *seq_btn_random;
    lv_obj_t *seq_btn_clear_grid;
    lv_obj_t *seq_btn_play_stop;
    lv_obj_t *seq_panel_track;
    lv_obj_t *seq_track_1;
    lv_obj_t *seq_track_1_state;
    lv_obj_t *seq_track_2;
    lv_obj_t *seq_track_2_state;
    lv_obj_t *seq_track_3;
    lv_obj_t *seq_track_3_state;
    lv_obj_t *seq_track_4;
    lv_obj_t *seq_track_4_state;
    lv_obj_t *seq_track_5;
    lv_obj_t *seq_track_5_state;
    lv_obj_t *seq_track_6;
    lv_obj_t *seq_track_6_state;
    lv_obj_t *seq_track_7;
    lv_obj_t *seq_track_7_state;
    lv_obj_t *seq_track_8;
    lv_obj_t *seq_track_8_state;
    lv_obj_t *seq_track_name;
    lv_obj_t *seq_panel_pattern;
    lv_obj_t *obj153;
    lv_obj_t *seq_pattern_str;
    lv_obj_t *seq_pattern_save_selected;
    lv_obj_t *seq_pattern_load_selected;
    lv_obj_t *obj154;
    lv_obj_t *seq_pattern_a;
    lv_obj_t *seq_pattern_b;
    lv_obj_t *seq_pattern_c;
    lv_obj_t *seq_pattern_d;
    lv_obj_t *seq_pattern_e;
    lv_obj_t *seq_pattern_f;
    lv_obj_t *seq_panel_track_param;
    lv_obj_t *obj155;
    lv_obj_t *seq_track_btn_lock;
    lv_obj_t *seq_track_dropdown;
    lv_obj_t *obj156;
    lv_obj_t *seq_track_btn_restore;
    lv_obj_t *seq_track_btn_mute;
    lv_obj_t *seq_track_btn_solo;
    lv_obj_t *obj157;
    lv_obj_t *seq_track_sld_randtemp;
    lv_obj_t *seq_track_sld_velocity;
    lv_obj_t *seq_track_sld_probability;
    lv_obj_t *obj158;
    lv_obj_t *seq_btn_grid_page_switch;
    lv_obj_t *seq_grid_track_name;
    lv_obj_t *seq_grid;
    lv_obj_t *seq_grid_step_name;
    lv_obj_t *seq_pattern_list;
    lv_obj_t *obj159;
    lv_obj_t *seq_list_file_return;
    lv_obj_t *seq_list_file_delect;
    lv_obj_t *seq_list_file_select;
    lv_obj_t *seq_list_file;
    lv_obj_t *seq_panel_grid_set;
    lv_obj_t *obj160;
    lv_obj_t *seq_grid_set_return;
    lv_obj_t *seq_grid_set_cancel;
    lv_obj_t *seq_grid_set_confirm;
    lv_obj_t *obj161;
    lv_obj_t *obj162;
    lv_obj_t *seq_grid_set_velocity;
    lv_obj_t *obj163;
    lv_obj_t *seq_grid_set_probability;
    lv_obj_t *obj164;
    lv_obj_t *seq_grid_set_cc_value;
    lv_obj_t *seq_grid_set_cc_select;
    lv_obj_t *obj165;
    lv_obj_t *obj166;
    lv_obj_t *seq_grid_set_cc_value_display;
    lv_obj_t *seq_led_ai;
    lv_obj_t *obj167;
    lv_obj_t *obj168;
    lv_obj_t *obj169;
    ...
    lv_obj_t *midi_panel_record_list;
    lv_obj_t *midi_list_record_file;
    lv_obj_t *midi_del_msgbox;
    lv_obj_t *obj178;
    lv_obj_t *obj179;
...
void create_screen_app_recorder();
void delete_screen_app_recorder();
void tick_screen_app_recorder();

void create_screen_app_tiny_piano();
void delete_screen_app_tiny_piano();
void tick_screen_app_tiny_piano();

void create_screen_app_sequencer();
void delete_screen_app_sequencer();
void tick_screen_app_sequencer();
