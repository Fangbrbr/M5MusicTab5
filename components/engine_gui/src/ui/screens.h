...
typedef struct _objects_t {
    ...
    lv_obj_t *drum_panel_vkit;
    lv_obj_t *drum_vkit_;
    lv_obj_t *drum_vkit_hitom;
    lv_obj_t *drum_vkit_snare;
    lv_obj_t *drum_vkit_midtom;
    lv_obj_t *drum_vkit_floortom;
    lv_obj_t *drum_vkit_ride;
    lv_obj_t *drum_vkit_hihat;
    lv_obj_t *drum_vkit_crash;
